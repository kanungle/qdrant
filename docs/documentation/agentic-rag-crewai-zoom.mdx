---
title: "Agentic RAG With CrewAI & Qdrant Vector Database"
sidebarTitle: "Simple Agentic RAG System"
---

<Frame>
  <img src="/images/agentic-rag-1.png" />
</Frame>
...
<Frame>
  <img src="/images/agentic-rag-2.png" />
</Frame>
...
2. Get API Credentials for AI Services:
    ...
    - Get an API key from [OpenAI](https://platform.openai.com/docs/overview)
...
cd agentic_rag_zoom_crewai
  ...
  <Step title="Create and Activate a Python Virtual Environment with Python 3.10 for compatibility:">
```bash
...
```
  ...
  <Step title="Install Dependencies:">
    ...
    <Step title="Configure Environment Variables: Create a .env.local file with:">
```bash
...
<Steps>
  <Step title="Process Meeting Data">
...
<Frame>
  <img src="/images/agentic-rag-3.png" />
</Frame>
